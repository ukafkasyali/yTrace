...
| 1:34–1:50 | Click **Find similar incidents across runs** and show the ranked cohort | “Trace now retrieves comparable raw windows across recordings using deterministic torque features, then exports the cohort for review or labeling. Similarity is a lead, not a shared-cause claim.” |
