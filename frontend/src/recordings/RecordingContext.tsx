...
type Props = { display?: 'overview' | 'robot'; datasetId: string; data: DemoData; playhead: number; interval: Interval; highlighted: string[]; onMarker: (marker: Marker) => void; onHighlight: (id: string) => void; onData: () => void };
