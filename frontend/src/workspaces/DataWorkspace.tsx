  ...
  return <section className="workspace-content" aria-labelledby="data-title">
    ...
    <details className="recording-summary">
      ...
      <div className="recording-details">
        <p><strong>{data.recording.id}</strong> · Recorded telemetry with a {data.recording.displaySampleRateHz} Hz overview. Outside the raw interval, y/trace only shows display-resolution data.</p>
