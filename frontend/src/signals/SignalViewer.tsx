...
type Props = { data: DemoData; playhead: number; interval: Interval; viewport: Interval; highlighted: string[]; following: boolean; zoom: number; onSelect: (v: Interval) => void; onFollow: () => void; onZoom: (seconds: number) => void };

export default function SignalViewer({ data, playhead, interval, viewport, highlighted, following, zoom, onSelect, onFollow, onZoom }: Props) {
